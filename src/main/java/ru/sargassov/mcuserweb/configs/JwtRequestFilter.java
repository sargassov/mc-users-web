...
@Slf4j
public class JwtRequestFilter extends OncePerRequestFilter { //настройка фильтров Security
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        String jwt = null;
        if (authHeader != null && authHeader.startsWith("Bearer ")) { //валидатор токена
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {//регистрация пользователя и выдача ему токена
